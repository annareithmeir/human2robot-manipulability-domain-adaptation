...
dqrd = panda_bimanual.relative_pose(q); % relative pose
dqad_ant = panda_bimanual.absolute_pose(q); % pose inbetween EEs, q=[q1;q2]

pose_abs = panda_bimanual.absolute_pose_jacobian(q) % 8x14 matrix
absolute_manipulability = pose_abs * pose_abs'; %8*8
