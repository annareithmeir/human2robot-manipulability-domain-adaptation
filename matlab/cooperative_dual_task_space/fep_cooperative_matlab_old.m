...
% q1_goal = [2.4384 -0.3518 0.5410 -1.9826 0.3599 3.1207 1.3489]; Works
% really well
...
%     jacob2 = panda_bimanual.absolute_pose_jacobian(q);
    ...
    robustInv2 = jacob2'*pinv(jacob2*jacob2' + 0.001*eye(3) );    
...
ylabel('y-axis')
zlabel('z-axis')
title("Path towards goal with the bimanual setup");
hold on
plot3(data.fep_xm(1,:),data.fep_xm(2,:),data.fep_xm(3,:),'b','LineWidth',3);
hold on
plot(fep1, q1);
plot(fep2, q2); 
hold off
